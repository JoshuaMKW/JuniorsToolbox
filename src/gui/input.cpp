...
namespace Toolbox::UI::Input {
	// Anonymous namespace within Input allows us to have private-scope variables that are only accessible from this TU.
...
bool Toolbox::UI::Input::GetKey(uint32_t key) {
...
bool Toolbox::UI::Input::GetKeyUp(uint32_t key) {
	return mPrevKeysDown[key] && !mKeysDown[key];
}

bool Toolbox::UI::Input::GetMouseButton(uint32_t button) {
...
glm::vec2 Toolbox::UI::Input::GetMousePosition() {
	return mMousePosition;
}

glm::vec2 Toolbox::UI::Input::GetMouseDelta() {
	return mMouseDelta;
}

int32_t Toolbox::UI::Input::GetMouseScrollDelta() {
...
void Toolbox::UI::Input::GLFWKeyCallback(GLFWwindow* window, int key, int scancode, int action, int mods) {
	if (key >= KEY_MAX)
		return;
...
void Toolbox::UI::Input::GLFWMouseButtonCallback(GLFWwindow* window, int button, int action, int mods) {
...
void Toolbox::UI::Input::GLFWMouseScrollCallback(GLFWwindow* window, double xoffset, double yoffset) {
