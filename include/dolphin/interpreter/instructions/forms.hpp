...
#define FORM_LI(inst)    (s32)(((inst)&0x3fffffc) >= 0x2000000 ? ((inst)&0x3fffffc) - 0x4000000 : ((inst)&0x3fffffc))
#define FORM_BO(inst)    (u8)(((inst) >> 21) & 0x1f)
#define FORM_BI(inst)    (u8)(((inst) >> 16) & 0x1f)
#define FORM_BD(inst)    (s16)((inst) & 0xfffc)
#define FORM_D(inst)     (s16)((inst) & 0xffff)
#define FORM_SI(inst)    (s16)((inst) & 0xffff)
#define FORM_UI(inst)    (u16)((inst) & 0xffff)
...
#define FORM_SPR(inst)        ((s16)(((inst) >> 16) & 0x1f) | (s16)((((inst) >> 11) & 0x1f) << 5))
